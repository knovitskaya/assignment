...
class TestStringMethods(unittest.TestCase):
    ...
    def test_login(self):
        ...
        self.driver.find_element_by_xpath("//input[@name='email']").send_keys(self.Username1)
        self.driver.find_element_by_xpath("//input[@name='password']").send_keys(self.Password1)
        ...
        self.driver.find_element_by_xpath("//input[@type='email']").send_keys(self.Username2)
        self.driver.find_element_by_xpath("//input[@type='submit']").click()
        time.sleep(2)
        self.driver.find_element_by_xpath("//input[@type='password']").send_keys(self.Password2)
        self.driver.find_element_by_xpath("//input[@type='submit']").click()
